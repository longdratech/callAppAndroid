package com.ntt.ecl.webrtc.sample_p2p_call.views;
...
import com.ntt.ecl.webrtc.sample_p2p_call.R;

public class RipplePulse extends RelativeLayout {
    ...
    public RipplePulse(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public RipplePulse(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs);
    }

    @RequiresApi(Build.VERSION_CODES.LOLLIPOP)
    public RipplePulse(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        @SuppressLint({"Recycle", "CustomViewStyleable"}) TypedArray attrValues = context.obtainStyledAttributes(attrs, R.styleable.RipplePulseLayout);
